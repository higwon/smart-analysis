...
| ID | Task | Depends | Legacy | Reuse/rewrite | Prio | MVP | Status |
|---|---|---|---|---|---|---|---|
| V00 | Rendering spike + lib decision (ADR) | F03 | SciChart usage (doc 05) | New (Candidate libs) | P0 | ✅ | review (ADR-018: ScottPlot 5 → Approved; spike renders 1M pts headless via ICurveView) |
