...
|---|---|---|---|---|---|---|---|---|
| F00 | Repository & Solution bootstrap | — | none | New (minimal skeleton) | `.sln` + minimal MVP projects + reference skeleton + build/Nullable settings + test project base; **no commercial libs, no domain/algorithm/parser/UI code** | P0 | ✅ | ready |
...
| F02 | DI Composition Root + Architecture Tests | F00 | none (no DI legacy) | New | DI root wires modules; NetArchTest enforces doc 11 dependency rules. **Parallel with F01/F03** | P0 | ✅ | planned |
