...
| **New product code / `.sln`** | 🟢 `TASK-F00`/`F01`/`F03` **merged** on `main`. 🟡 `TASK-D01` (channel descriptors + metadata; datasets upgraded) implemented on `feat/task-d01-channel-metadata`; **Draft PR under review**. |
